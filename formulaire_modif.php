       ...
       die("La table est vide");
        ...
        <div class='col-12'>
            <div class='form-group'>
                ...
                {   
                    echo"<select class='form-control' name='categorie' id='catégorie' value='$produit->cat_id'>
                    <option>$produit->cat_nom</option>
                    </select>";
                }
                ?>
                <?php
                ...
                <input class='form-control'  type='text' name='date_ajout' id='date_ajout' value='$produit->pro_d_ajout'>
                <label for='date_modif'>Date de modification :</label>
                <input class='form-control'  type='text' name='date_modif' id='date_modif' value='$produit->pro_d_modif'>
                </div> 
